  ...
  return (
    <>
      <div className="nd-workspace-wrapper">
          <Button type="link" onClick={() => history.push(`/main/workspace/${currentWs}/info`)}>
            Info
          </Button>
          <Button type="link" onClick={() => history.push(`/main/workspace/${currentWs}/invitations`)}>
            Invitations
          </Button>
          <Button type="link" onClick={() => history.push(`/main/workspace/${currentWs}/members`)}>
            Members
          </Button>
          <Button type="link" onClick={() => history.push(`/main/workspace/${currentWs}/holidays`)}>
            Holidays
          </Button>
          <br />
          <Switch>
            ...
            <Route path={WORKSPACE_ROUTES.INVITATIONS} component={WorspaceInvitations} />
            <Route path={WORKSPACE_ROUTES.HOLIDAYS} component={WorspaceHolidays} />
          </Switch>
        </div>
    </>
  )
